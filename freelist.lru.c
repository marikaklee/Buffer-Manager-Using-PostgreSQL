/*-------------------------------------------------------------------------
 *
 * Name: Marika Lee (collaborated with Masaya Ando)
 ...
 * 
 * 
 * Function: StrategyLRUEnqueue()
 * Places current buffer block into tail of the list 
 */
 ...
 * CS460
 * 
 * Function: StrategyLRUDequeue()
 * Extracts buffer block from the head of the list 
 */
